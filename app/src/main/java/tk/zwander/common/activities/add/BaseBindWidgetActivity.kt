...
import tk.zwander.common.util.getIconReflect
import tk.zwander.common.util.toInsecureStringCompat
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                        ...
                        if (pinItemRequest != null) {
                            val name = pinItemRequest.shortcutInfo?.run { longLabel ?: shortLabel }
                                ?.toString() ?: "Unknown"
                            val icon = pinItemRequest.shortcutInfo?.getIconReflect()
                                ?.loadDrawable(this)
                            ...
                            if (intent == null) {
                                val msg = "Unable to find intent for pin request.\n" +
                                        ...
                                        "Shortcut Info: ${pinItemRequest.shortcutInfo?.toInsecureStringCompat()}"
