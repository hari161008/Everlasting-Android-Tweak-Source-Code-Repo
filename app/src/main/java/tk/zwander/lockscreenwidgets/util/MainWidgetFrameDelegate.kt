...
import com.coolappstore.everlastingandroidtweak.databinding.WidgetGridHolderBinding
        ...
        val wallpaperInfo = if (showWallpaperLayer) {
            ...
            try {
                ...
                drawable?.mutate()?.let {
                    ...
                    val loc = run { val loc = intArrayOf(0, 0); frame.getLocationOnScreen(loc); loc }
