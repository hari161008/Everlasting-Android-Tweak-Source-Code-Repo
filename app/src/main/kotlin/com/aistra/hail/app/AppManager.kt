...
object AppManager {
    ...
    fun setListFrozen(frozen: Boolean, vararg appInfo: AppInfo): String? {
        val excludeMe = appInfo.filter { it.packageName != "com.coolappstore.everlastingandroidtweak" }
        var i = 0
        var denied = false
        var name = String()
    ...
    fun setAppFrozen(packageName: String, frozen: Boolean): Boolean =
        packageName != "com.coolappstore.everlastingandroidtweak" && when (HailData.workingMode) {
