...
import com.coolappstore.everlastingandroidtweak.databinding.FragmentAppsBinding
...
class AppsFragment : MainFragment(), AppsAdapter.OnItemClickListener, AppsAdapter.OnItemCheckedChangeListener,
    ...
    override fun onCreateView(
        ...
        binding.refresh.apply {
            ...
            applyDefaultInsetter { marginRelative(requireContext().isRtl, start = !requireContext().isLandscape, end = true) }
        }
        binding.recyclerView.apply {
            ...
            adapter = appsAdapter
            applyDefaultInsetter { paddingRelative(requireContext().isRtl, bottom = requireContext().isLandscape) }
