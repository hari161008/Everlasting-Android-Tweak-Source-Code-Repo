    ...
    private fun SettingsScreen() {
        ...
        LazyColumn(modifier = Modifier.fillMaxSize()) {
            ...
            listPreference(
                ...
                onValueChange = { _, _ ->
                    // DO NOT call app.setAppTheme() here — it triggers UiModeManager /
                    // AppCompatDelegate night-mode change which recreates the Activity.
                    // The SharedPreferences write done by the preference library is enough:
                    // Hail's AppTheme observes APP_THEME via observeAsState and recomposes
                    // automatically, and MainActivity's LaunchedEffect keeps EVERLASTING_THEME_MODE
                    // in sync so the whole app updates without any restart.
                    true
                },
