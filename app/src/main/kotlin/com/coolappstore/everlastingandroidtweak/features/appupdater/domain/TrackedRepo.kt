package com.coolappstore.everlastingandroidtweak.features.appupdater.domain
...
data class TrackedRepo(
    ...
    @SerializedName("selectedApkName") val selectedApkName: String,
    @SerializedName("mappedPackageName") val mappedPackageName: String?,
